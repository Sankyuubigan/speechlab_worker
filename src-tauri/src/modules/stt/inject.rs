...
///
/// Uses `arboard` for Unicode-safe clipboard access and Win32 SendInput for Ctrl+V.
...
fn send_ctrl_v() -> Result<(), String> {
    use windows::Win32::UI::Input::KeyboardAndMouse::{
        SendInput, INPUT, INPUT_0, INPUT_KEYBOARD, KEYEVENTF_KEYUP,
        MapVirtualKeyW, VIRTUAL_KEY, VK_CONTROL, VK_V, MAPVK_VK_TO_VSC,
    };
